...
//--------这里修改定义端口------//
#define OLED_SCL  PTB0_OUT
#define OLED_SDA  PTB1_OUT
#define OLED_RST  PTB2_OUT
#define OLED_DC   PTB3_OUT

#define OLED_SCL_PIN  PTB0
#define OLED_SDA_PIN  PTB1
#define OLED_RST_PIN  PTB2
#define OLED_DC_PIN   PTB3
